  ...
  return (
    <AppShell hideNav headerContent={<AdminHomeHeader />}>
      <section className="mx-auto max-w-7xl px-2 py-3 sm:px-4 lg:px-6">
        <Link href="/admin" className="focus-ring inline-flex items-center gap-2 rounded-md border border-ink/15 bg-white px-3 py-2 text-sm font-semibold">
      ...
      <section className="mx-auto grid max-w-7xl gap-3 px-2 pb-4 sm:px-4 lg:grid-cols-[minmax(0,1.35fr)_300px] lg:px-6">
        <section className="rounded-xl border border-ink/10 bg-white p-2.5 shadow-sm">
          ...
          <div className="mt-2 max-h-[calc(100vh-11rem)] overflow-y-auto overflow-x-hidden pr-1">
